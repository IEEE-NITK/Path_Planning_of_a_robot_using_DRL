        ...
        if timestep < max_timesteps:
            ...
            if done:
                ...
                if timesteps_since_eval >= eval_freq:
                    ...
                    network.save(file_name, directory="./src/drlbot_description/runs/train/pytorch_models")
                    np.save("./src/drlbot_description/runs/train/results/%s" % (file_name), evaluations)
                    epoch += 1
